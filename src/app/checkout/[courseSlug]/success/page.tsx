        ...
        {state === 'guest' && (
          <>
            ...
            <p className="text-neutral-400 text-sm mb-6 leading-relaxed">
              Your enrollment is confirmed. If this is your first purchase, we sent an email to set your password,
              then you can sign in and access <span className="text-white font-medium">{params.courseSlug.replace(/-/g, ' ')}</span>.
            </p>
